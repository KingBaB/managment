...
<html>
<head>
    <title>Coach Pic Update Page</title>
</head>
<body>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">更改教练头像</h4>
            </div>
...
<script type="text/javascript">
    $(".update_pic_btn").click(function () {
        var coach_pic_id = $(".coach_id").text();
        ...
        $.ajax({
            url: "/coach/updateCoach/"+coach_pic_id,
            type: "POST",
            data: picFormData,
            async: false,
            cache: false,
            ...
            success: function (result) {
                if (result.code == 100){
                    ...
                    window.location.href="/coach/coachInfo.jsp?coach_id="+coach_pic_id;
                }else {
                    alert("教练头像修改异常！");
                }
            }
