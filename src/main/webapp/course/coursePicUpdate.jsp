    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">更改课程图片</h4>
            </div>
...
<script type="text/javascript">
    $(".update_pic_btn").click(function () {
        var course_pic_id = $(".course_id").text();
        ...
        $.ajax({
            url: "/course/updateCourse/"+course_pic_id,
            type: "POST",
            data: picFormData,
            async: false,
            cache: false,
            ...
            success: function (result) {
                if (result.code == 100){
                    ...
                    window.location.href="/course/courseInfo.jsp?course_id="+course_pic_id;
                }else {
                    alert("课程图片修改异常！");
                }
            }
