...
<html>
<head>
    <title>Equipment Pic Update Page</title>
</head>
<body>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">更改设备图片</h4>
            </div>
...
<script type="text/javascript">
    $(".update_pic_btn").click(function () {
        var equipment_pic_id = $(".equipment_id").text();
        ...
        $.ajax({
            url: "/equipment/updateEquipment/"+equipment_pic_id,
            type: "POST",
            data: picFormData,
            async: false,
            cache: false,
            ...
            success: function (result) {
                if (result.code == 100){
                    ...
                    window.location.href="/equipment/equipmentInfo.jsp?equipment_id="+equipment_pic_id;
                }else {
                    alert("设备图片修改异常！");
                }
            }
